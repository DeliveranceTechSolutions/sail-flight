...
// Include the generated spark config constants
include!(concat!(env!("OUT_DIR"), "/spark_config.rs"));
// Define KeyValue type locally since it's not available from connect module
#[derive(Debug, Clone)]
pub struct KeyValue {
    pub key: String,
...
impl From<KeyValue> for ConfigKeyValue {
...
impl From<ConfigKeyValue> for KeyValue {
